import asyncio
import datetime
import re     # re -regularExpression -- matnlar uchun shablon
...
# foydalanuvchini (read-only) ya'ni faqat o'qitish rejimiga o'tkazib qo'yamiz
...
# read-only holatidan qayta tiklaymiz
...
# Foydalanuvchini ban qilish (haydab yuborish)
...
# Foydalanuvchini ban dan chiqarish, foydalanuvchini guruhga qo'sha olmaymiz (o'zi qo'shilishi mumkin)
...
async def unban_user(message:types.Message):
    ...
    service_message=await message.reply("Xabar 5 sekunddan keyin o'chib ketadi")
    await asyncio.sleep(5)
    await message.delete()
    await service_message.delete()
